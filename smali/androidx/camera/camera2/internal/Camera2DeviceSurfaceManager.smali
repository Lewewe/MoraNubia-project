...
# direct methods
.method public static synthetic $r8$lambda$xWY42AK-EjayCQkPUR_iERCg4Uc(II)Z
    .locals 0
...
.method public checkSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    .line 116
    invoke-virtual {p0, p2}, Landroidx/camera/camera2/internal/SupportedSurfaceCombination;->checkSupported(Ljava/util/List;)Z
...
.method public getMaxOutputSize(Ljava/lang/String;I)Landroid/util/Size;
    ...
    .line 220
    invoke-virtual {p0, p2}, Landroidx/camera/camera2/internal/SupportedSurfaceCombination;->getMaxOutputSizeByFormat(I)Landroid/util/Size;
    ...
    const-string v0, "Fail to find supported surface info - CameraId:"
...
.method public getPreviewSize()Landroid/util/Size;
    ...
    .line 242
    invoke-virtual {p0}, Landroidx/camera/camera2/internal/SupportedSurfaceCombination;->getSurfaceSizeDefinition()Landroidx/camera/core/impl/SurfaceSizeDefinition;

    move-result-object p0

    .line 243
    invoke-virtual {p0}, Landroidx/camera/core/impl/SurfaceSizeDefinition;->getPreviewSize()Landroid/util/Size;
...
.method public getSuggestedResolutions(Ljava/lang/String;Ljava/util/List;Ljava/util/List;)Ljava/util/Map;
    ...
    .line 197
    invoke-virtual {p0, p2, p3}, Landroidx/camera/camera2/internal/SupportedSurfaceCombination;->getSuggestedResolutions(Ljava/util/List;Ljava/util/List;)Ljava/util/Map;
    ...
    const-string v1, "No supported surface combination is found for camera device - Id : "
