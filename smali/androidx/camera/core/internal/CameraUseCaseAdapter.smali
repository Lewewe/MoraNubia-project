...
.method private calculateSuggestedResolutions(Ljava/util/List;Ljava/util/List;)Ljava/util/Map;
    ...
    .line 306
    invoke-virtual {v3}, Landroidx/camera/core/UseCase;->getDefaultBuilder()Landroidx/camera/core/impl/UseCaseConfig$Builder;
    ...
    invoke-virtual {v3, v5, v4}, Landroidx/camera/core/UseCase;->applyDefaults(Landroidx/camera/core/impl/UseCaseConfig;Landroidx/camera/core/impl/UseCaseConfig$Builder;)Landroidx/camera/core/impl/UseCaseConfig;
    ...
    .line 316
    :cond_1
    iget-object p0, p0, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mCameraDeviceSurfaceManager:Landroidx/camera/core/impl/CameraDeviceSurfaceManager;
    ...
    .line 317
    invoke-interface {p0, v1, v0, p1}, Landroidx/camera/core/impl/CameraDeviceSurfaceManager;->getSuggestedResolutions(Ljava/lang/String;Ljava/util/List;Ljava/util/List;)Ljava/util/Map;
...
.method public addUseCases(Ljava/util/Collection;)V
    ...
    .line 208
    iget-object p0, p0, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mCameraInternal:Landroidx/camera/core/impl/CameraInternal;

    invoke-interface {p0, v2}, Landroidx/camera/core/impl/CameraInternal;->attachUseCases(Ljava/util/Collection;)V
    ...
    .line 213
    invoke-virtual {p1}, Landroidx/camera/core/UseCase;->notifyState()V
    ...
    .line 170
    :cond_6
    new-instance p0, Landroidx/camera/core/internal/CameraUseCaseAdapter$CameraException;

    const-string p1, "Attempting to bind too many ImageCapture or VideoCapture instances"

    invoke-direct {p0, p1}, Landroidx/camera/core/internal/CameraUseCaseAdapter$CameraException;-><init>(Ljava/lang/String;)V
...
.method public getCameraInternals()Ljava/util/Collection;
    ...
    .line 394
    iget-object p0, p0, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mCameraInternals:Ljava/util/LinkedHashSet;
...
.method public getUseCases()Ljava/util/List;
    ...
    iget-object p0, p0, Landroidx/camera/core/internal/CameraUseCaseAdapter;->mUseCases:Ljava/util/List;
...
.method public isEquivalent(Landroidx/camera/core/internal/CameraUseCaseAdapter;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/camera/core/internal/CameraUseCaseAdapter$CameraId;->equals(Ljava/lang/Object;)Z
